               ...
               <div class="col-xs-12 col-sm-12 col-md-8">
                  <div class="block block-default block-list-new">
                     <div class="block-header">
                        <h2 class="title">Truyện mới<span class="pull-right"><a href="https://truyencv.com/loc-truyen/" rel="nofollow"><small class="text-muted">Lọc truyện</small></a></span></h2>
                     </div>
                     <div class="block-content">
                        <ul class="list-group">
                           @foreach($truyen_theloai as $tr)
                           ...
                           @endforeach
                           <div class="row">{{$truyen_theloai->links()}}</div>
                        </ul>
